import { StyleSheet, Text, View, Pressable, Image, TouchableOpacity, TextInput, Modal } from 'react-native'
        ...
        <View style={styles.backroundModal}>
          <View style={styles.popup}>
            ...
            <View style={styles.viewCenter}>
              <Image style={{width: 80,height: 84,}} source={require('../../assets/otpIllustration.png')}/>
            </View>
            <View style={styles.viewCenter}>
              <Text style={styles.textLargePopup}>Nhập mã OTP</Text>
            </View>
            <View style={styles.viewCenter}>
              <Text style={styles.textSmallPopup}>Nhập mã OTP mà chúng tôi vừa gửi đến email của bạn để xác minh tài khoản.</Text>
            </View>
            <View style={styles.containerTextInput}>
              <TextInput keyboardType="numeric" caretHidden={true} underlineColor="transparent" style={styles.textInputOTP} placeholder="Enter OTP Code" />
            </View>
